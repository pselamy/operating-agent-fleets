...
Medium packages are delayed-import control envelopes, not duplicate article bodies. The canonical page supplies the article through Medium's URL importer only after deployment, independent reachability and indexability checks, and the external human release gate. This avoids maintaining a second prose source while still pinning the intended chapter, import method, stop conditions, comparison surface, and post-action verification procedure.
